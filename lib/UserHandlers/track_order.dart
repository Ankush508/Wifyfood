...
Future<ResForTrackOrder> getTrackOrderData(String userId) async {
  var link = Uri.parse("https://wifyfood.com/api/users/trackorder/$userId");
...
Future<List<MenuDetail>> getTrackOrderMenuListData(String userId) async {
...
Future<List<DeliveryDetail>> getTrackOrderDelListData(String userId) async {
...
Future<List<KitchenDetail>> getTrackOrderKitListData(String userId) async {
  print("Orde Id : $userId");
