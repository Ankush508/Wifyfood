...
class TrackOrderScreenHome extends StatefulWidget {
  final List<String> address;
  final String userId, cityId;
  TrackOrderScreenHome(this.address, this.userId, this.cityId);
  @override
  _TrackOrderScreenHomeState createState() => _TrackOrderScreenHomeState();
}

class _TrackOrderScreenHomeState extends State<TrackOrderScreenHome> {
  ...
  void initState() {
    ...
    string5 = 'assets/svg/Tracking_red.svg';
    super.initState();
  }
            ...
            child: Container(
              ...
              child: Center(
                child: GestureDetector(
                  onTap: () {
                    Provider.of<CartCount>(context, listen: false).getIndex(0);
                  },
                  child: Container(
...
class TrackOrderHomeScreen extends StatefulWidget {
  final String userId;
  final LocationData userData, kitData;
  TrackOrderHomeScreen(this.userId, this.userData, this.kitData);
  @override
  _TrackOrderScreenState createState() => _TrackOrderScreenState();
}

class _TrackOrderScreenState extends State<TrackOrderHomeScreen>
  ...
  void initState() {
    ...
    timer = new Timer.periodic(Duration(seconds: 2), (timer) async {
      ...
      getTrackOrderHomeMenuListData(widget.userId).then((value) {
      ...
      getTrackOrderHomeDelListData(widget.userId).then((value) {
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                //                   widget.userId, widget.kitchenId),
                //             ),
                //           );
                //         },
                //         child: Container(
