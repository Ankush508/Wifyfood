...
import 'package:wifyfood/KitchenHandlers/forgot_check_otp.dart';
...
class ForgotOTPScreen extends StatefulWidget {
  final String mobile;
  ForgotOTPScreen(this.mobile);
  @override
  _EnterOTPScreenState createState() => _EnterOTPScreenState();
}

class _EnterOTPScreenState extends State<ForgotOTPScreen> {
  Timer timer;
  int start = 10;
                        ...
                        onTap: () {
                          if (_formKey.currentState.validate()) {
                            ...
                            if (otp == null || otp == "") {
                              ...
                              getForgotCheckOtpData(widget.mobile, otp)
                                  .then((value) {
                                setState(() {
                                  _isLoading = false;
                                });
                                if (value.status == 1) {
                                  ...
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          ForgotPasswordScreen(widget.mobile),
                                    ),
                                  );
                                } else {
                                  Fluttertoast.showToast(
