...
class _OrderDeliveredScreenState extends State<OrderDeliveredScreen> {
  ...
  Widget orders(List<OrderDelivered> order) {
  ...
  Widget ordersFilter(List<OrderDeliveredFilter> order) {
    return (order.length == 0)
        ? Container(
            height: 100,
            child: Center(
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text(
            Languages.of(context).ord + " " + Languages.of(context).del,
          ...
          children: [
            ...
            SafeArea(
              ...
              children: [
                ...
                (filter == true)
                    ? FutureBuilder(
                        future: getOrderDeliveredFilterListData(
                    ...
                    : FutureBuilder(
                        future: getOrderDeliveredListData(widget.kid),
                        builder: (context, snapshot) {
                          return snapshot.data != null
